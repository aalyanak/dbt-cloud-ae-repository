    ...
    create or replace table `analytics-engineering-398318`.`ae_tier1_raw`.`user_conversion_without_live_session`
...
wo_live_session as (
  select 
    ...
    us.user_session_gid, 
    CASE 
            WHEN c.channel_name is not null and c.channel_name = 'direct' THEN  'direct' 
            ELSE  'other' 
